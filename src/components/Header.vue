<template>
  ...
  <header id="top-header">
    ...
    <div id="hamburger" @click="hamburger()" :class="{'change':isclass}">
      <span></span>
      <span></span>
      <span></span>
    </div>
...
.top-footer .header-logo {
  ...
  #hamburger.change span:nth-of-type(1) {
    top: 20px;
    transform: rotate(45deg);
  }

  #hamburger.change span:nth-of-type(2) {
    opacity: 0;
  }
  #hamburger.change span:nth-of-type(3) {
    top: 20px;
    transform: rotate(-45deg);
  }
  .menu-content {
